  ...
  render() {
    const contactCard = this._submitted
      ? html`<contact-card
          ...
          description="
          La Red de Proveedores de Servicios para Inmigrantes (ISPN) apoya a los nacidos en el extranjero y sus familias en la región de St. Louis aumentando los recursos de la comunidad, abogando por políticas y servicios inclusivos y educando a residentes y proveedores."
          linkText="Sitio Web"
